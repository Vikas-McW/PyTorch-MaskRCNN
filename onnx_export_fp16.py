...
torch.onnx.export(model.cpu(), 
                ...
                "weight/mask_rcnn_fp16.onnx",
                verbose=True,
                opset_version=11)

onnx_model = onnx.load("weight/mask_rcnn_fp16.onnx")
model_simp, check = simplify(onnx_model)
onnx.save(model_simp, "weight/mask_rcnn_simple_fp16.onnx")

print("Onnx FP16 Conversion Done...!")
